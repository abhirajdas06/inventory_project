/* ============================================================
   static/js/harddisk_table.js  —  Hard Disk list page
============================================================ */

$(document).ready(function () {

    console.log("harddisk_table.js loaded");

    // ----------------------------------------
    // INIT DATATABLE
    // ----------------------------------------
    if ($.fn.DataTable.isDataTable('#harddiskTable')) {
        $('#harddiskTable').DataTable().destroy();
    }

    let table = $('#harddiskTable').DataTable({
        pageLength: 25,
        scrollX: true,
    ...
    // COLUMN FILTER
    // ----------------------------------------
    $('#harddiskTable thead tr.filter-row th').each(function (i) {
    ...
    // INLINE EDIT
    // ----------------------------------------
    $('#harddiskTable tbody').on('click', '.editable-cell', function () {
